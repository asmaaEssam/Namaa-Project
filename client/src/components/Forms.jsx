...
const Forms = ({ stateFromDataEntry }) => {
  // 5: form state is whatever the user enters only
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:9000/footpath/add", data)
      .then(({ data }) => {
        console.log(data);
      })
      .catch((err) => {
          ...
          <CardBody>
            <div className="form-row">
              ...
              <FormGroup className="col-md-4">
                <Input
                  type="text"
                  // show preexisting values for editing purposes

                  placeholder={
                    stateFromDataEntry.surveyorname || "Employee Name"
                  }
                  id="surveyorname"
                  name="surveyorname"
                  onChange={inputHandler}
