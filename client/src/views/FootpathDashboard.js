...
class Dashboard extends React.Component {
  ...
  factor3.data = this.state.geojson.map(f=>f.fallenBranches)
  let chartExample3 = {
    data: canvas => {
    ...
    return (
      <div id= 'dashboard'>
          ...
          <Col lg="6">
              ...
              <CardBody>
                <Map style='mapbox://styles/asma163/ckbgkzh7457611io4q6k872re' token='pk.eyJ1IjoiYXNtYTE2MyIsImEiOiJja2I0MnJwMm4wYnFvMnJvNnA2NjBmdnN2In0.QVk1j8vEHjmZA0YZOyv7VA' height="44.5vh" center = {[31.637929, 30.100782]}/>
              </CardBody>
              </Card>
          </Col>
          <Col lg="3">
              <Card className="card-chart">
                <CardBody>
                  ...
                  <h3 style={{textAlign:'center', color: "#e14eca"}}>55 %</h3>
                </CardBody>
              </Card>
              <Card className="card-chart">
                <CardBody>
